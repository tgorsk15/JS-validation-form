...
/* input:not(:focus):not(:placeholder-shown):valid */`, "",{"version":3,"sources":["webpack://./src/styles.css"],"names":[],"mappings":"AAAA;IACI,YAAY;IACZ,WAAW;AACf;;AAEA;IACI,yDAA6C;IAC7C,wBAAwB;IACxB,gBAAgB;IAChB,kBAAkB;AACtB;;AAEA;IACI,iBAAiB;IACjB,gBAAgB;IAChB,iBAAiB;IACjB,iBAAiB;IACjB,kBAAkB;IAClB,uBAAuB;IACvB,aAAa;IACb,6BAA6B;IAC7B,SAAS;IACT,OAAO;IACP,uBAAuB;IACvB,iCAAiC;AACrC;;AAEA;IACI,kBAAkB;IAClB,WAAW;AACf;;AAEA;IACI,0BAA0B;AAC9B;;AAEA;IACI,cAAc;;AAElB;;AAEA;IACI,gBAAgB;IAChB,eAAe;AACnB;;AAEA;IACI,eAAe;IACf,YAAY;AAChB;;AAEA;IACI,uBAAuB;IACvB,6BAA6B;AACjC;;AAEA;;IAEI,kBAAkB;AACtB;;AAEA;IACI,uBAAuB;IACvB,kBAAkB;IAClB,aAAa;AACjB;;AAEA;IACI,uBAAuB;IACvB,kBAAkB;IAClB,SAAS;AACb;;AAEA;IACI,uBAAuB;IACvB,kBAAkB;IAClB,aAAa;AACjB;;AAEA;IACI,gBAAgB;AACpB;;AAEA;IACI,gBAAgB;IAChB,YAAY;IACZ,eAAe;IACf,iBAAiB;AACrB;;;;AAIA,oDAAoD","sourcesContent":["html {\n    height: 100%;\n    width: 100%;\n}\n\nbody {\n    background-image: url('./sky-background.jpg');\n    background-size: contain;\n    min-height: 100%;\n    position: relative;\n}\n\n.form-container {\n    min-height: 660px;\n    max-width: 490px;\n    padding: 0px 29px;\n    padding-top: 20px;\n    position: absolute;\n    background-color: white;\n    display: grid;\n    grid-template-rows: 1fr 4.5fr;\n    left: 37%;\n    top: 8%;\n    border: 2px solid black;\n    box-shadow: 0px 3px 7px 0px black;\n}\n\n.form-title {\n    text-align: center;\n    grid-row: 1;\n}\n\n#fillout-form {\n    /* justify-self: center; */\n}\n\nlabel, input, select {\n    display: block;\n    \n}\n\nlabel {\n    margin-top: 33px;\n    font-size: 22px;\n}\n\ninput, select {\n    font-size: 19px;\n    width: 300px;\n}\n\ninput:not(:focus):not(:placeholder-shown):invalid {\n    background-color: white;\n    /* border: 2px solid black; */\n}\n\n.email-container, .country-container, \n.zipcode-container, .passwords-container {\n    position: relative;\n}\n\n.email-error, .country-error, .zipcode-error {\n    color: rgb(156, 73, 73);\n    position: absolute;\n    bottom: -20px;\n}\n\n.password1-error {\n    color: rgb(156, 73, 73);\n    position: absolute;\n    top: 54px;\n}\n\n.password2-error {\n    color: rgb(156, 73, 73);\n    position: absolute;\n    bottom: -22px;\n}\n\n#password2-label {\n    margin-top: 50px;\n}\n\n.submit-button {\n    margin-top: 46px;\n    height: 25px;\n    font-size: 18px;\n    margin-left: 15px;\n}\n\n\n\n/* input:not(:focus):not(:placeholder-shown):valid */"],"sourceRoot":""}]);
// Exports
